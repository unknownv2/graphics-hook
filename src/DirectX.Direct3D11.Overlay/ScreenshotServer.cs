...
namespace DirectX.Direct3D11.Overlay
{
    ...
    internal class ScreenshotServer
    {
        ...
        private Direct3DHook _hookModule;

        internal ScreenshotServer(Type service, Func<RequestContext, Func<Task>, Task> handler, Direct3DHook hookModule)
        {
            _service = service;
            _handler = handler;
